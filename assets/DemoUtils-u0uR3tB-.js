import{A as h}from"./ApiTable-ofntdkrP.js";import{d as T,o as n,c as o,a as e,t as p,b as a,u as i,a0 as u,g,F as q,j as s,_ as R}from"./index-C1Ta0UHV.js";import{h as d}from"./demoCodeHighlight-DiBXU18_.js";const j={class:"doc-content__header"},v={class:"utils-usage"},k={class:"demo-code-panel"},x={key:0,class:"utils-usage utils-usage--signature"},O={class:"demo-code-panel"},A={key:1,class:"utils-usage utils-usage--impl"},C={class:"demo-code-panel"},_={class:"api-section"},P=T({__name:"DemoUtils",props:{activeKey:{default:"rgbaToHex"}},setup(y){const f=y,l={rgbaToHex:{key:"rgbaToHex",name:"rgbaToHex",desc:"将 rgba/rgb 颜色字符串转为十六进制颜色值",signature:"declare const rgbaToHex: (color: string) => string;",usage:`import { rgbaToHex } from "jsh-tool/color";
...
await formRef.value?.validate();`,api:[{name:"_comp",type:"组件构造函数",default:"—",required:!0,desc:"Vue 组件"},{name:"返回值",type:"Ref<InstanceType<T>>",default:"—",required:!0,desc:"组件实例 ref"}]}},t=s(()=>l[f.activeKey]||l.rgbaToHex),b=s(()=>d(t.value.usage)),m=s(()=>t.value.signature?d(t.value.signature):""),c=s(()=>t.value.implementation?d(t.value.implementation):"");return(E,r)=>(n(),o(q,null,[e("div",j,[e("h2",null,p(t.value.name),1),e("p",null,p(t.value.desc),1)]),e("div",v,[r[0]||(r[0]=e("h4",{class:"utils-usage__title"},"基础用法",-1)),e("div",k,[a(i(u),{code:t.value.usage,highlighted:b.value},null,8,["code","highlighted"])])]),m.value?(n(),o("div",x,[r[1]||(r[1]=e("h4",{class:"utils-usage__title"},"配置参数",-1)),e("div",O,[a(i(u),{code:t.value.signature,highlighted:m.value},null,8,["code","highlighted"])])])):g("",!0),c.value?(n(),o("div",A,[r[2]||(r[2]=e("h4",{class:"utils-usage__title"},"体操实现",-1)),e("div",C,[a(i(u),{code:t.value.implementation,highlighted:c.value},null,8,["code","highlighted"])])])):g("",!0),e("div",_,[r[3]||(r[3]=e("h3",{class:"api-section__title"},"参数说明",-1)),a(h,{type:"props",rows:t.value.api},null,8,["rows"])])],64))}}),w=R(P,[["__scopeId","data-v-762b947d"]]);export{w as default};
