import{d as w,o as a,c as o,a as t,F as p,e as g,P as T,t as u,b as E,w as L,Z as A,Y as k,f as I,g as y,$ as j,a1 as H,j as V,h as G,_ as M}from"./index-C1Ta0UHV.js";const N=`# 版本变更记录
...
`,W={class:"cl"},z={class:"cl__list"},F=["onClick"],O={class:"cl__ver-tag"},U={class:"cl__ver-date"},$={class:"cl__body"},q={class:"cl__mod-name"},R={key:0,class:"cl__grp-type"},J={class:"cl__items"},K={class:"cl__item-content"},Y={key:0,class:"cl__tag"},Z=w({__name:"ChangelogPanel",setup(Q){function _(s){return s.includes("新增")?"#10b981":s.includes("调整")||s.includes("修改")?"#4366f1":s.includes("修复")?"#f59e0b":s.includes("移除")||s.includes("删除")?"#ef4444":"#94a3b8"}function B(s){const h=[],r=s.split(`
`);let c=null,n=null,e=null;for(const l of r){const m=l.match(/^## (v[\d.]+)(?:[（(](.+?)[）)])?/);if(m){c={version:m[1],date:m[2]??"",modules:[]},h.push(c),n=null,e=null;continue}if(!c)continue;const b=l.match(/^### (.+)/);if(b){n={name:b[1],groups:[]},c.modules.push(n),e=null;continue}const f=l.match(/^#### (.+)/);if(f&&n){e={type:f[1],items:[]},n.groups.push(e);continue}const C=l.match(/^- \*\*(.+?)\*\*[：:](.+)/);if(C){const i={label:C[1],text:C[2].trim()};e?e.items.push(i):n&&(n.groups.length||n.groups.push({type:"",items:[]}),n.groups[n.groups.length-1].items.push(i));continue}const v=l.match(/^- (.+)/);if(v&&!v[1].startsWith("*")){const i={label:"",text:v[1].trim()};e?e.items.push(i):n&&(n.groups.length||n.groups.push({type:"",items:[]}),n.groups[n.groups.length-1].items.push(i));continue}const S=l.match(/^\s+- (.+)/);if(S){const i=e??(n==null?void 0:n.groups[n.groups.length-1]);if(i&&i.items.length>0){const P=i.items[i.items.length-1];P.text+=`；${S[1].trim()}`}}}return h}const D=V(()=>B(N)),d=G(0);function x(s){d.value=d.value===s?-1:s}return(s,h)=>(a(),o("div",W,[t("div",z,[(a(!0),o(p,null,g(D.value,(r,c)=>(a(),o("div",{key:r.version,class:"cl__ver"},[t("div",{class:"cl__ver-head",onClick:n=>x(c)},[t("span",{class:T(["cl__dot",{"is-latest":c===0}])},null,2),t("span",O,u(r.version),1),t("span",U,u(r.date),1),t("span",{class:T(["cl__arrow",{"is-open":d.value===c}])},null,2)],8,F),E(H,{name:"cl-expand"},{default:L(()=>[A(t("div",$,[(a(!0),o(p,null,g(r.modules,n=>(a(),o("div",{key:n.name,class:"cl__mod"},[t("div",q,u(n.name),1),(a(!0),o(p,null,g(n.groups,e=>(a(),o(p,{key:e.type},[e.type?(a(),o("div",R,[t("span",{class:"cl__grp-dot",style:k({background:_(e.type)})},null,4),I(" "+u(e.type),1)])):y("",!0),t("div",J,[(a(!0),o(p,null,g(e.items,(l,m)=>(a(),o("div",{key:m,class:"cl__item"},[t("span",{class:"cl__item-bullet",style:k({background:_(e.type)})},null,4),t("div",K,[l.label?(a(),o("code",Y,u(l.label),1)):y("",!0),t("span",null,u(l.text),1)])]))),128))])],64))),128))]))),128))],512),[[j,d.value===c]])]),_:2},1024)]))),128))])]))}}),nn=M(Z,[["__scopeId","data-v-4673bf7e"]]);export{nn as default};
